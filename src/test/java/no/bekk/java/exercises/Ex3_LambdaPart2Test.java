...
public class Ex3_LambdaPart2Test {
	...
	public void testAgeOfOldestPlayer() {
		...
		Integer ageOfOldestPlayer = Ex3_LambdaPart2.ageOfOldestPlayer(players);
	...
	public void testPlayersWithNamesStartingWith() {
		...
		List<Player> playersWithNameStartingWithM = Ex3_LambdaPart2.playersWithNamesStartingWith("M", players);
	...
	public void testAverageAgeOfPlayers() {
		...
		Double averageAge = Ex3_LambdaPart2.averageAgeOfPlayers(players);
	...
	public void testSumValueOfTeams() {
		Double premierLeagueTeamsValue = Ex3_LambdaPart2.sumValueOfAllTeams(premierLeague.teams);
	...
	public void testYoungestPlayer() {
		...
		Player youngestPlayer = Ex3_LambdaPart2.youngestPlayer(players);
	...
	public void testTeamWithHighestValue() {
		Team teamWithHighersValueInPremierLeague = Ex3_LambdaPart2.teamWithHighestValue(premierLeague.teams);
	...
	public void testGroupPlayersByBirthYear() {
		...
		Map<Integer, List<Player>> groupedPlayers = Ex3_LambdaPart2.groupPlayersByBirthYear(players);
	...
	public void testSumValuesOfEachLeague() {
		List<Double> values = Ex3_LambdaPart2.sumValuesOfEachLeague(leagues);
	...
	public void testPlayersBornBefore() {
		...
		List<Player> playersOlderThanMinAge = Ex3_LambdaPart2.playersBornBefore(minAge, leagues);
	...
	public void testSortByAgeAndThenName() {
		...
		List<Player> result = Ex3_LambdaPart2.sortByAgeAndThenName(players);
	...
	public void testNameOfPlayerClosestToAverageAge() {
		...
		String nameOfPlayerClosestToAverage = Ex3_LambdaPart2.nameOfPlayerClosestToAverageAge(players);
	...
	public void testYoungestPlayerOnEachTeamMappedByTeamName() {
		...
		Map<String, Player> result = Ex3_LambdaPart2.youngestPlayerOnEachTeamMappedByTeamName(asList(manchesterUnited, liverpool, arsenal));
