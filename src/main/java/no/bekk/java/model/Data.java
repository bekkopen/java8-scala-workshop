    ...
    public static List<League> getAllLeagues() {
        return asList(
                new League("Premier League", asList(
                        new Team("Manchester United", 2_810_000_000.0, asList(
                        ...
                        new Team("Liverpool", 691_000_000.0, asList(
                        ...
                        new Team("Arsenal", 1_330_000_000.0, asList(
                ...
                new League("La Liga", asList(
                        new Team("Real Madrid", 3_440_000_000.0, asList(
                        ...
                        new Team("Barcelona", 3_200_000_000.0, asList(
                        ...
                        new Team("Atletico Madrid", 328_000_000.0, asList(
                ...
                new League("Bundesliga", asList(
                        new Team("Bayern München", 1_850_000_000.0, asList(
                        ...
                        new Team("Borussia Dortmund", 600_000_000.0, asList(
                        ...
                        new Team("Schalke 04", 580_000_000.0, asList(
